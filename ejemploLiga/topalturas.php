...
if ($conexion->connect_errno) {
  ...
  $resultado = $conexion->query("SELECT id_jugador,nombre,apellido,altura FROM jugador ORDER BY altura DESC LIMIT 5");
}
 ?>
<!DOCTYPE html>
      ...
      <nav>
        <div class="nav-wrapper">
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            <li><a href="topsalario.php">Listado Alturas</a></li>
